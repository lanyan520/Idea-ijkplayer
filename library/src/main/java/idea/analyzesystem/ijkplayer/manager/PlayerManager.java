package idea.analyzesystem.ijkplayer.manager;
...
import idea.analyzesystem.ijkplayer.media.IRenderView;
import idea.analyzesystem.ijkplayer.media.IjkVideoView;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity,int ijkVideoPlayerResId) {
        try {
        ...
        videoView = (IjkVideoView) activity.findViewById(ijkVideoPlayerResId);
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public void toggleVoice(boolean isCloseVoice){
        if(isCloseVoice){
    ...
    public Bitmap getCaptureBitmap(){
        return videoView.getCaptureBitmap();
    }
